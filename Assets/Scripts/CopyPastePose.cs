...
public class CopyPastePose : MonoBehaviour {
    ...
    [MenuItem("Tools/Copy Paste Pose/Copy Pose")]
    ...
    [MenuItem("Tools/Copy Paste Pose/Copy Pose", true)]
    static bool ValidateCopyPose() {
        return Selection.activeTransform != null;
    }

    [MenuItem("Tools/Copy Paste Pose/Paste Pose")]
    ...
    [MenuItem("Tools/Copy Paste Pose/Paste Pose", true)]
